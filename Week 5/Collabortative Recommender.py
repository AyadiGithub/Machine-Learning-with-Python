...
# Collaborative Filtering RECOMMENDATION SYSTEM Using Pearson Correlation Function
...
#Top 50 similar users to InputUser

topUsers=pearsonDF.sort_values(by='similarityIndex', ascending=False)[0:50]
topUsers.head()

# Starting to recommend movies to InputUser
